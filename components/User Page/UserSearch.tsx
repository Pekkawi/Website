      ...
      <div className="relative flex w-full max-w-2xl items-center">
        <div className="relative grow">
          <input
            ...
            className="w-full rounded-l-md border border-gray-300 bg-white px-4 py-2 pl-10 pr-10 text-sm text-gray-900 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-orange-500 dark:focus:ring-orange-500"
          />
        ...
        <button
          onClick={applyFilter}
          className="rounded-r-md bg-orange-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-orange-600  dark:bg-orange-600 dark:hover:bg-orange-700"
        >
          Search
        </button>
      </div>
