  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="fixed bottom-10 right-14 size-14 rounded-full bg-orange-500 p-0 shadow-xl hover:bg-orange-600">
          <Plus className="size-6 text-white" />
        </Button>
      </DialogTrigger>
      <DialogContent className="background-light900_dark300 sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="font-semibold">Create New Node</DialogTitle>
        </DialogHeader>
