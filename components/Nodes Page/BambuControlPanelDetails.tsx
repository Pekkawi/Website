...
import { BambuControlPanelNode } from '@/interfaces/nodes.interface';
...
interface BambuControlPanelNodeDetailsProps {
  node: BambuControlPanelNode;
}

const BambuControlPanelDetails: React.FC<BambuControlPanelNodeDetailsProps> = ({
  node,
}) => {
              ...
              <DialogHeader className="space-y-2">
                ...
                <DialogDescription>
                  <div className="space-y-2">
                    ...
                    <p>
                      Deleting this node will also delete{' '}
                      <strong>all of the printer nodes it controls</strong>.
                    </p>
